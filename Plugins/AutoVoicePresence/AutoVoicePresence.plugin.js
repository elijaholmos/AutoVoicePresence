...
module.exports = (() => {
	const config = {
		info: {
			name: 'AutoVoicePresence',
			authors: [{ name: 'Ollog10', discord_id: '139120967208271872', github_username: 'elijaholmos' }],
			version: '1.2.1',
			description: 'Automatically updates your rich presence when your voice activity changes',
			github_raw:
				'https://raw.githubusercontent.com/elijaholmos/BetterDiscordAddons/master/Plugins/AutoVoicePresence/AutoVoicePresence.plugin.js',
		},
		main: 'index.js',
		changelog: [{ title: 'Bug Fixes', type: 'fixed', items: ['Now works with BetterDiscord v1.8.2'] }],
	};
		...
		: (([Plugin, Api]) => {
				const plugin = (Plugin, Library) => {
					...
					const DiscordConstants = {
						GuildFeatures: Webpack.getModule(Webpack.Filters.byProps('DISCOVERABLE'), {
							searchExports: true,
						}),
