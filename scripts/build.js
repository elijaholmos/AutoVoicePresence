// derived from https://github.com/rauenzi/BetterDiscordAddons/blob/master/scripts/build.js
...
for (let f = 0; f < list.length; f++) {
    ...
    let result = formatString(template, {
        ...
        SOURCE: config.info.github_raw || formatString(buildConfig.github, {PLUGIN_NAME: pluginName}),
